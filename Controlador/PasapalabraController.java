...
public class PasapalabraController {
    ...
    public PasapalabraController(PasapalabraView vista, PasapalabraModel modelo) {
        this.vista = vista;
        this.modelo = modelo;

        actualizarVistaPregunta();

        // Le damos vida a los botones (hemos quitado la línea del RootPane que daba error)
    ...
    private void avanzarTurno() {
        ...
        if (quedanPreguntas) {
            ...
            JOptionPane.showMessageDialog(vista, "Juego Terminado. Vuelve al menú principal.");
        }
    }
